...
class _$HomeStateTearOff {
  ...
  _Initial call(
    ...
    return _Initial(
      ...
      trndingMovesList: trndingMovesList,
      tenseMovieList: tenseMovieList,
...
mixin _$HomeState {
  ...
  List<HotandNewData> get pastYearMovieList =>
      throw _privateConstructorUsedError;
  List<HotandNewData> get trndingMovesList =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<HotandNewData> trndingMovesList,
...
class _$HomeStateCopyWithImpl<$Res> implements $HomeStateCopyWith<$Res> {
  ...
  @override
  $Res call({
    Object? statId = freezed,
    Object? pastYearMovieList = freezed,
    Object? trndingMovesList = freezed,
    ...
    return _then(_value.copyWith(
      ...
      trndingMovesList: trndingMovesList == freezed
          ? _value.trndingMovesList
          : trndingMovesList // ignore: cast_nullable_to_non_nullable
              as List<HotandNewData>,
...
class _$_Initial implements _Initial {
  const _$_Initial(
      ...
      required this.trndingMovesList,
      required this.tenseMovieList,
  ...
  @override
  final List<HotandNewData> trndingMovesList;
  @override
  final List<HotandNewData> tenseMovieList;
  @override
  ...
  @override
  String toString() {
    return 'HomeState(statId: $statId, pastYearMovieList: $pastYearMovieList, trndingMovesList: $trndingMovesList, tenseMovieList: $tenseMovieList, southIndianMovieList: $southIndianMovieList, trendingTvList: $trendingTvList, isLoading: $isLoading, hasError: $hasError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _Initial &&
            const DeepCollectionEquality().equals(other.statId, statId) &&
            const DeepCollectionEquality()
                .equals(other.pastYearMovieList, pastYearMovieList) &&
            const DeepCollectionEquality()
                .equals(other.trndingMovesList, trndingMovesList) &&
            const DeepCollectionEquality()
                .equals(other.tenseMovieList, tenseMovieList) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(statId),
      const DeepCollectionEquality().hash(pastYearMovieList),
      const DeepCollectionEquality().hash(trndingMovesList),
      const DeepCollectionEquality().hash(tenseMovieList),
